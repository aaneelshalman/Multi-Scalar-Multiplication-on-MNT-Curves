; ModuleID = 'probe6.860c7716a104620b-cgu.0'
source_filename = "probe6.860c7716a104620b-cgu.0"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h89a7cb7da05b1967E"(double %self) unnamed_addr #0 {
start:
...
define void @_ZN6probe65probe17h6a5323eab5b6314cE() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h89a7cb7da05b1967E"(double 1.000000e+00)
  ret void
}
